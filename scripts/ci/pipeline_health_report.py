#!/usr/bin/env python3
"""Compute rolling health for PR Validation and Release workflows."""
...
def write_md(path: str, report: dict[str, Any], days: int, pr_threshold: float, rel_threshold: float) -> None:
    ...
    lines = [
        ...
        (
            f"| Release | {rel['success']} | {rel['failure']} | {rel['cancelled']} | "
...
def main() -> int:
    ...
    report = {
        ...
        "thresholds": {
            ...
            "release_success_rate": args.release_threshold,
        },
