...
| 4 — later | 3scale port abstractions ([#67](https://github.com/Everything-is-Code/gateforge/issues/67)), OpenAPI typegen ([#69](https://github.com/Everything-is-Code/gateforge/issues/69)), optional E2E workflow (`workflow_dispatch`) |
