...
| Class | ~LOC | Notes |
|-------|------|-------|
| `MigrationService` | ~1,000 | Plan orchestration; persistence via `MigrationPlanRepository` |
| `service/migration/*` | small | `BackendEndpointResolver`, `OpenApiSynthesisService`, `ClusterResourceApplyService` |
