 ...
 * Derived from the consolidated 3scale → Connectivity Link taxonomy (PPT audit + GateForge implementation).
 */
public final class PolicyMappingCatalog {
    ...
    /** How GateForge handles this mapping today in {@code MigrationService.analyze}. */
    ...
    public record ConsolidatedMapping(
            ...
            String apiGroup,
            Layer layer,
            ImplementationStatus gateforgeStatus,
            String notes
    ) {}
    ...
    public static List<ConsolidatedMapping> consolidated() {
        return List.of(
                ...
                new ConsolidatedMapping(
                        ...
                        Layer.EXTENSION,
                        ImplementationStatus.GENERATED,
                        "When gateforge.observability.enabled=true"),
                new ConsolidatedMapping(
                        "OAuth browser flow",
                        "OIDCPolicy",
                        "extensions.kuadrant.io/v1alpha1",
