...
class MigrationPlanRepositoryTest {
    ...
    void saveAndLoad_roundTripsConsolidationWarnings() {
        ...
        List<String> warnings = List.of(
                "Product 'demo-api': APIProduct skipped — enable gateforge.developer-hub.enabled for Developer Portal catalog tier."
        );
        MigrationPlan plan = new MigrationPlan(
                planId,
                "shared",
                List.of("demo-api"),
                List.of(new MigrationPlan.GeneratedResource("Gateway", "gateforge-shared", "kuadrant-system", "kind: Gateway")),
                "analysis",
                Instant.now(),
                null,
                "ACTIVE",
