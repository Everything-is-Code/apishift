...
import io.apishift.service.support.RemoteCacheStub;
import io.apishift.service.support.StubThreeScaleAdminApiClient;
import io.apishift.service.support.ThreeScaleAdminApiFixtures;
import io.apishift.service.support.ThreeScaleServiceTestSupport;
import io.apishift.service.support.ThreeScaleTestRegistry;
...
class ThreeScaleServiceTest extends ThreeScaleServiceTestSupport {
    ...
    void clearExportOverride_restoresAdminApiProducts() {
        ...
        ThreeScaleService service = createService(
                ThreeScaleTestRegistry.withStub("source-a", "Source A", client), cache);
        ReflectionTestSupport.inject(service, "exportParser", new io.apishift.service.export.ThreeScaleExportParser());
