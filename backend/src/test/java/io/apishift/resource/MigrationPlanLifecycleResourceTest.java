...
import io.apishift.service.support.MigrationKubernetesTestSupport;
...
class MigrationPlanLifecycleResourceTest {
    ...
    void stubDependencies() {
        ...
        when(clusterRegistry.getCluster(anyString())).thenReturn(io.apishift.model.TargetCluster.local());
    }
